...
export default function PageB({ setCurrentPage }: componentProp) {
    ...
    const fullnameStyle = emptyFields.includes('fullname')
        ? 'solid 2px red'
        : '';
    const emailStyle = emptyFields.includes('email') ? 'solid 2px red' : '';
    const passwordStyle = emptyFields.includes('password')
        ? 'solid 2px red'
        : '';
    ...
    const handleClick = (e: React.FormEvent) => {
        ...
        if (!error) {
            updateUser({ fullname, password, email });
            setCurrentPage(3);
        }
    };
                ...
                >
                    ...
                    <div className=" flex flex-col my-3 space-y-4">
                        ...
                        <div className="flex w-full">
                            <motion.input
                                initial={childrenVariant.initial}
                                animate={childrenVariant.animate}
