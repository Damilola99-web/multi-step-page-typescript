...
export default function PageA({ setCurrentPage }: componentProp) {
                ...
                <div className=" flex justify-end w-full items-start">
                    <div className=" flex flex-col justify-end">
                        <motion.p
                            ...
                            dragElastic={0.4}
                            className=" text-gray-600 text-lg font-semibold text-right"
                        >
                    ...
                    <div className="  w-full flex flex-col space-y-6">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className=" text-gray-500 font-semibold text-base">
                                    Personal account to manage all your
                                    activities.
                                </p>
                            </div>
                            <img
                        ...
                        >
                            <div className=" relative hidden md:block lg:block">
                                <img
                                    className=" w-[55px] group-hover:w-[63px]"
                                    src={POLYGON}
                                    alt=""
                                />
                                <img
                            ...
                            <div>
                                ...
                                <p className=" text-gray-500 font-semibold text-base">
                                    Own a company or belong to a company, this
                                    is for you.
                                </p>
                            </div>
                            <img
